...
- **Proof** — homepage shows real anonymized audits across Canada: 650+ sites tested, average 54.5/100, 46 cities (BC/QC/ON/MB examples)

## Current verified stats (audit campaign, mobile / slow 4G)
- **650+** unique Canadian business websites tested
- **46** cities across Canada
- **Average score: 54.5/100** (up-to-date union of every scored wave)
- **24 sites reached green (90+)** — about 4% of sites
- **272 sites scored under 50** — about 42%, the red zone on Google's scale
- **Best: 99 · Worst: 6**

> Every number is the real Google PageSpeed mobile test (homepage, simulated phone, slow 4G) — never invented. See the blog post [I tested 650 Canadian websites](https://speed.stephanedube.dev/blog/canadian-website-speed-test) for the write-up.
...
- `/blog` + 4 posts (`/blog/*`), each with sidebar (CTA + related posts). Flagship: "I tested 650 Canadian websites"
